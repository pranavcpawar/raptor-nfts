...
const AlertBox = () => {
  ...
  return (
    <div className={`fixed inset-0 min-h-screen place-items-center ${loader.isLoading && alertBox.isAlert == true ? " ": "bg-black bg-opacity-50 backdrop-blur-sm"} transform transition-transform duration-300 ${alertBox.isAlert ?"grid": "hidden"} rounded-[5px]`}>
